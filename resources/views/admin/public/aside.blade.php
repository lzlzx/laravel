        ...
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('添加角色','/admin/role/create')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加角色</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('分类列表','/admin/cate')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>分类列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('添加分类','/admin/cate/create')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加分类</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('添加文章','/admin/article/create')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加文章</cite></a>
                    </li>
                </ul>
