                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="get" action="{{ url('admin/user') }}">
                                ...
                                {{--</div>--}}
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="username"  placeholder="请输入用户名"  class="layui-input" value="{{ $username }}">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="id" value="1" data-id="{{ $v->user_id }}"   lay-skin="primary">
                                    </td>
                                    <td>{{$v->user_id}}</td>
                                    <td>{{$v->user_name}}</td>
                                    <td>{{$v->email}}</td>
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <a title="编辑"  onclick="xadmin.open('编辑','/admin/user/{{$v->user_id}}/edit',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
